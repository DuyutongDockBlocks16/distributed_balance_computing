create external table if not exists wzwd.wzwd_ods_game_NMError_d (
    ...
    STORED AS TEXTFILE
    LOCATION '/staging/wzwd/nm/k8s/NMError';

ALTER TABLE wzwd.wzwd_ods_game_NMError_d add if not exists PARTITION(nm_version='${nm_version}')
    LOCATION '/staging/wzwd/nm/k8s/NMError/${nm_version}';
