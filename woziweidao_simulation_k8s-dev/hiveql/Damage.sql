create external table if not exists wzwd.wzwd_ods_game_Damage_d (
    ...
    damageSource          INT COMMENT '伤害来源（普攻，技能ID，反伤，召唤物攻击）',
    ...
    STORED AS TEXTFILE
    LOCATION '/staging/wzwd/nm/k8s/Damage';

ALTER TABLE wzwd.wzwd_ods_game_Damage_d add if not exists PARTITION(nm_version='${nm_version}')
    LOCATION '/staging/wzwd/nm/k8s/Damage/${nm_version}';
